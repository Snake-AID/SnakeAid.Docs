...
5. Upload tài liệu cần tư vấn:
   ...
   - Mô tả vấn đề
   - Câu hỏi cụ thể
6. Thanh toán phí tư vấn trước (`FE-27`):
...
2. Trong app Rescuer chọn **"Yêu cầu hỗ trợ chuyên gia"** (`FE-12`).
3. Chụp ảnh/video rắn real-time (`FE-14`).
...
6. Bắt đầu tư vấn qua chat/video call (`FE-11`): Expert xác định loài rắn, tư vấn cách bắt an toàn và cảnh báo rủi ro.
...
2. Bắt đầu phiên tư vấn (`FE-10`) — Chat text hoặc Video call.
3. Expert xem thông tin Patient đã gửi: ảnh, mô tả, câu hỏi.
4. Expert tư vấn, đưa khuyến nghị, có thể yêu cầu thêm thông tin.
5. Expert có thể: cập nhật hướng dẫn sơ cứu (`FE-07`, `FE-08`), cung cấp thông tin liều lượng huyết thanh (`FE-09`) hoặc khuyến nghị đến bệnh viện.
6. Kết thúc buổi tư vấn: Expert đánh dấu "Hoàn thành" (`FE-14`) và thời gian tư vấn được ghi nhận.
7. Hệ thống xử lý thanh toán: chuyển tiền từ escrow sang Expert (`FE-14`), trừ phí nền tảng 10%, xuất hóa đơn.
8. Patient đánh giá Expert (1–5 sao + nhận xét).
9. Lưu lịch sử tư vấn & báo cáo cho Patient / Expert / Admin (`FE-30`, `FE-15`, `FE-19`).
