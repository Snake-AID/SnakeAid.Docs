...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2 | Function Code |  |  |  |  | Function Name |  |  |  |  |  | ConfirmConsultationPayment |  |  |  |  |  |  |  |  |
| 3 | Created By |  |  |  |  | Executed By |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 4 | Lines  of code |  | TBD |  |  | Lack of test cases |  |  |  |  |  | TBD |  |  |  |  |  |  |  |  |
| 5 | Test requirement |  | Member can confirm a pending PayOS consultation payment |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
...
| 36 |  |  |  | Payment confirmation behavior TBD |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 37 |  | Exception |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
