# Report 4 Table Descriptions Draft

## Purpose

This file is the draft source for the final `Table Descriptions` section before insertion into the Report 4 document.
...
- This draft is intentionally close to final report wording.
- Verification-heavy tables should still be checked against current code before insertion into the main report file.
