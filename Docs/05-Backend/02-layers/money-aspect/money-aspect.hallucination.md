...
| Snake Catching | ambiguity lớn nhất là còn `transfer-to-rescuer` và commission split hay không | đã khóa và implement tới mức settlement endpoint deprecation: không phải escrow; không còn payout/platform-fee side-effect trên customer payment path |
